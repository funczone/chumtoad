 ...
 * @property {Object} commands.rcon - Rcon login information.
 * @property {string} commands.rcon.ip - The IP to connect to.
 * @property {string} commands.rcon.pass - The password to rcon.
